...
module.exports = {
	...
	async execute(client, interaction) {
		...
		const tableEmbed = new Discord.MessageEmbed({
			...
			fields: [{ name: "Registered:", value: "\u200B", inline: true }],
			timestamp: Date.now(),
		});
...
function removeArrayItemOnce(array, value) {
